// @circuit-llm/vault — the off-chain client for the non-custodial circuit-agent-vault program.
//
//   import { VaultClient, loadVaultProgram, makeVaultExecutor } from '@circuit-llm/vault';
//   const program = loadVaultProgram(connection, wallet);
//   const vault = new VaultClient(program);
//   // makeVaultExecutor(...) plugs into @circuit-llm/agent's VaultCustody (paper=false) to land real trades.
//
