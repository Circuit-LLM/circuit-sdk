...
Want a smaller footprint? Install only what you need — every surface is also its own `@circuit/*` package. Full map: **[packages](https://github.com/Circuit-LLM/circuit-sdk/blob/main/docs/packages.md)**.
