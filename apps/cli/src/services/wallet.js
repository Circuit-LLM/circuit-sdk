...
//
// Backed by @circuit/wallet (which was extracted FROM this file; the SDK gained the same multi-RPC
...
// CIRC mint/decimals/program match @circuit/core's DEFAULT_CONFIG (verified), so the SDK wallet uses the
...
import { Wallet } from '@circuit/wallet';
